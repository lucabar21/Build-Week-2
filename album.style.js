...
const albumApiKey = "1e76c6751dmshf6e51120c249691p17f828jsn056e3af8a78c";
const albumApiHost = "deezerdevs-deezer.p.rapidapi.com";

const params = new URLSearchParams(window.location.search);
const myAlbumId = params.get("albumId");

console.log(myAlbumId);

window.onload = () => {
  fetch(albumURL + myAlbumId, {
    headers: {
    ...
    .then((tracks) => {
      ...
      tracks.forEach((track, index) => {
        ...
        firstDivTrack.classList.add("music-list", "d-flex", "flex-column", "gap-3", "my-3");

        const secondDivTrack = document.createElement("div");
        secondDivTrack.classList.add("d-flex", "gap-4", "my-1", "mx-3", "align-items-center");
        ...
        firstDivIcon.classList.add("ms-auto", "d-flex", "gap-5", "align-items-center");
